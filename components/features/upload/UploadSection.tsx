  ...
  return (
    ...
    >
      ...
      <div className="space-y-8 relative z-10">
        <h2 className="text-4xl font-black text-slate-900 dark:text-white uppercase tracking-[0.1em]">Hirely AI Resume Helper</h2>
        <p className="max-w-3xl text-xl text-slate-500 dark:text-slate-500 leading-relaxed mx-auto font-medium transition-all">
