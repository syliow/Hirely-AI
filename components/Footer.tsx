...
export const Footer = () => (
  <footer className="w-full py-10 px-4 md:py-20 md:px-10 border-t border-slate-200 dark:border-white/5 mt-20 bg-white/60 dark:bg-[#020617]/60 backdrop-blur-md">
    <div className="max-w-6xl mx-auto flex flex-col items-center justify-center text-center gap-8 md:gap-12">
      <div className="flex flex-col items-center gap-6">
        <div className="flex items-center gap-4">
          <BrandLogo size={28} className="w-10 h-10 md:w-14 md:h-14" />
          <span className="text-xl md:text-2xl font-black tracking-tighter text-slate-900 dark:text-white uppercase">HIRELY<span className="text-violet-500">.AI</span></span>
        </div>
