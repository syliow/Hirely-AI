...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#020617] text-slate-200 font-sans selection:bg-violet-500/30">
      ...
      <main className="flex-1 w-full relative z-10 px-6 md:px-12 lg:px-24">
        
        {/* Only show strategy settings when editing/analyzing */}
        ...
        {loading || refactoring ? (
          ...
          />
           ...
           /* Default State: Upload & JD Input */
           <div className="max-w-4xl mx-auto w-full flex flex-col items-center space-y-12 animate-in fade-in slide-in-from-bottom-10 duration-500 py-12">
              <UploadSection 
